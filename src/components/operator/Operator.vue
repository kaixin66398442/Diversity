        ...
        <div class="page_size">
          ...
          <el-radio-group v-model="store.operator.pageSizeType">
            <el-radio
              label="preset"
              size="large"
              @change="store.operator.pageSizeType = 'preset'"
              >预设页面大小</el-radio
            >
            <!-- 预设页面大小 -->
            <el-select
              v-model="store.operator.pageSizeValue"
              size="small"
              :disabled="!(store.operator.pageSizeType === 'preset')"
              @change="presetChange"
            >
              <el-option
                v-for="ps in store.operator.pageSizeArr"
                :key="ps.value"
                :label="ps.label"
                :value="ps.value"
              />
            ...
            <el-radio
              label="custom"
              size="large"
              @change="store.operator.pageSizeType = 'custom'"
              >自定义大小</el-radio
            >
            <!-- 自定义大小 -->
            <div class="custom">
              <el-input-number
                v-model="data.container.width"
                :min="1"
                :max="10000"
          ...
          <div class="canvas-direction">
            <p>页面方向：</p>
            <el-select
              v-model="store.operator.canvaDirectionValue"
              size="small"
            >
              <el-option
                v-for="cd in store.operator.canvaDirectionArr"
                :key="cd.value"
                :label="cd.label"
                :value="cd.value"
              />
        ...
        <div class="background_grid">
          ...
          <div class="grid_type">
            ...
            <el-select v-model="store.operator.gridTypeValue" size="small">
              <el-option
                v-for="(type, index) in store.operator.gridTypeArr"
                :key="type.value"
                :label="type.label"
                :value="type.value"
              />
          ...
          <div class="grid_spacing">
            <p>网格间距</p>
            <el-slider
              v-model="store.operator.gridSpacingValue"
              :max="store.operator.gridSpacingMaxValue"
              :min="store.operator.gridSpacingMinValue"
              size="small"
            />
            <div class="value-box">
          ...
          <div class="grid_color">
            ...
            <el-color-picker
              v-model="store.operator.gridColorMainValue"
              size="small"
            />
            <div class="value-box" style="margin-left: 20px">次</div>
            <el-color-picker
              v-model="store.operator.gridColorSecondValue"
              size="small"
            />
          </div>
          <!-- 背景颜色 -->
          <div class="grid_background_color">
            <p>背景颜色</p>
            <el-color-picker
              v-model="store.operator.gridBackgroundColorValue"
              size="small"
            />
          </div>
        </div>
